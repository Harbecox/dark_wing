            ...
            <div class="airport">
                                ...
                                <div class="col-12 col-lg-4">
                                    <div class="d-flex flex-column align-items-center pb-5 pb-lg-0">
                                        ...
                                        <p class="fw-normal text-gray-4 lh-sm fs-22 text-center px-5 px-lg-0">
                                            ...
                                            <a class="fw-bold" href="https://api.whatsapp.com/send?phone={{ \Illuminate\Support\Str::replace("+","",$texts['contact']['WhatsApp']) }}">WhatsApp</a></p>
                                    </div>
                                </div>
                                <div class="col-12 col-lg-4">
                ...
                <div class="about" style="background-image: url('/image/about_bg.webp')">
                    <div class="container">
                        <div class="about_main">
                            <div class="simvol_title d-flex flex-column align-items-center">
                                <div class="simvol_image"><img alt="darkwinginflight"  src="/image/simvol.png"  width="auto" height="auto"></div>
                            ...
                            <div class="position-relative about_image">
                                <img alt="darkwinginflight"  src="/image/bg_2.webp" class="w-100 h-100" width="1200px" height="300px">
                ...
                <div class="container">
                    <div class="partners">
                        ...
                        <div class="row">
                            <div class="col-lg-2 col-6 align-items-center"><img alt="darkwinginflight"  class="opacity-75 w-100 h-100" src="image/hotel_1.png"  width="200px" height="200px"></div>
                            <div class="col-lg-2 col-6 align-items-center"><img alt="darkwinginflight"  class="opacity-75 w-100 h-100" src="image/hotel_2.png"  width="200px" height="200px"></div>
                            <div class="col-lg-2 col-6 align-items-center"><img alt="darkwinginflight"  class="opacity-75 w-100 h-100" src="image/hotel_3.png"  width="200px" height="200px"></div>
                            <div class="col-lg-2 col-6 align-items-center"><img alt="darkwinginflight"  class="opacity-75 w-100 h-100" src="image/hotel_4.png"  width="200px" height="200px"></div>
                            <div class="col-lg-2 col-6 align-items-center"><img alt="darkwinginflight"  class="opacity-75 w-100 h-100" src="image/hotel_5.png"  width="200px" height="200px"></div>
                            <div class="col-lg-2 col-6 align-items-center"><img alt="darkwinginflight"  class="opacity-75 w-100 h-100" src="image/hotel_6.png"  width="200px" height="200px"></div>
                        </div>
                    </div>
                </div>
