        ...
        <div class="container">
            ...
            <div class="position-absolute luxury_title">
                <h1 class="fw-normal lh-1 text-white text-uppercase text-center tenor">Luxury catering<br>
                    around the world</h1>
                <p class="luxury_text p_lg fw-normal lh-sm  text-white text-center">We are here to provide you the best quality catering<br>service during your stay and departure</p>
            </div>
        ...
        <div class="container">
            <div class="about_main">
                ...
                <p class="p_lg fw-normal text-gray-5 lh-sm text-center pt-3">
                    ...
                    We are here to provide you the best quality catering service during your stay and departure.</p>
