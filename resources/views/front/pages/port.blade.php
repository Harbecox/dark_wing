    ...
    <div class="header_content">
        <div class="container">
            <div class="d-flex flex-column align-items-center port_main">
                <p class="p_md fw-bold lh-sm text-uppercase text-white text_back mt-0 mt-lg-5 d-flex"
                   style="opacity: 0.4" itemscope itemtype="http://schema.org/BreadcrumbList">
                    ...
                    <a itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"
                       href="{{route('all_airports')}}" class="d-flex align-items-center" style="margin: 0 5px">
                ...
                <div class="d-flex flex-column align-items-center port_title">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <h1 class="fw-normal lh-1 text-white text-uppercase tenor"
                            style="letter-spacing: -0.08em;">{{ $airport->title }} ({{ $airport->info->icao }}
                            , {{ $airport->info->iata }})</h1>
                    </div>
                </div>
                <div class="airport_info">
                    ...
                    <div class="d-lg-flex d-block justify-content-between">
                        <div class="info_text">
                            ...
                            <p class="fw-normal fs-22 text-white lh-sm">Country
                                : {{ $airport->info->country->name }}</p>
                        ...
                        <div class="info_text">
                            <p class="fw-normal fs-22 text-white lh-sm">Country Code
                                : {{ $airport->info->country->code }}</p>
            ...
            <div class="port_text_footer">
                <div class="simvol_title d-flex flex-column align-items-center" style="margin-bottom: 41px">
                    ...
                    <p class="fw-normal fs-30 lh-sm text-gray-6 text-center">Contact the Dark Wing
                        Inflight private jet catering team at <span>{{ $airport->title }} ({{ $airport->info->icao }}, {{ $airport->info->iata }}) in {{ $airport->info->city }}</span>
                        to discuss
                ...
                <div class="row">
                    <div class="col-12 col-lg-4">
                        <div class="d-flex flex-column align-items-center pb-5 pb-lg-0">
                            ...
                            <p class="fw-normal text-gray-4 lh-sm fs-22 text-center">by Continent, ICAO, IATA or
                                City</p>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4">
                        <div class="d-flex flex-column align-items-center pb-5 pb-lg-0">
                            ...
                            <h6 class="fw-normal text-white lh-sm " style="letter-spacing: -0.56px;">REQUEST & CONFIRM
                                QUOTE</h6>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="d-flex flex-column align-items-center">
                            ...
                            <h6 class="fw-normal text-white lh-sm " style="letter-spacing: -0.56px;">RECEIVE CATERING TO
                                YOUR JET</h6>
                            <p class="fw-normal text-gray-4 lh-sm fs-22 text-center">and enjoy your VIP meal under the
                                sky</p>
                        </div>
                    </div>
                </div>
