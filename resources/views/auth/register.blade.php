    ...
    <div class="contact_main">
        <div class="container">
            <h1 class="fw-normal lh-1 text-white text-uppercase  text-center tenor"
                style="letter-spacing: -0.08em; margin-bottom: 20px">New account</h1>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 offset-0 offset-md-3">
                                ...
                                <div class="col-md-12">
                                    <div class="fake_input d-flex position-relative w-100">
                                        ...
                                        <input id="password" type="password"
                                               class="@error('password') is-invalid d-block @enderror" name="password">
                                    </div>
                                    @error('password')
                            ...
                            <div class="d-flex justify-content-center">
                                <button class="btn text-white text-uppercase contact_button" style="width: 386px"><span
                                        class="pnt">~</span>REGISTER<span class="pnt">~</span>
                                </button>
                            </div>
                        </div>
                    </div>
