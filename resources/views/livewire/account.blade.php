            ...
            <div class="personal_main_right d-flex">
                <div class="d-flex flex-column personal_info">
                    <div class="personal_info_line">
                        ...
                        <div class="d-flex">
                            <input wire:model="user.firstName" value="{{$user->firstName}}" class="d-inline p_lg fw-normal lh-140 text-white bg-transparent border-0" id="name">
                    ...
                    <div class="personal_info_line">
                        ...
                        <div class="d-flex">
                            <input wire:model="user.company" value="{{$user->company}}" class="p_lg fw-normal lh-140 text-white bg-transparent border-0" id="company">
                ...
                <div class="d-flex flex-column personal_info">
                    <div class="personal_info_line">
                        ...
                        <div class="d-flex">
                            <p wire:model="user.email" class="p_lg fw-normal lh-140 text-white opacity-100">{{$user->email}}</p>
                        </div>
                    </div>
                    <div class="personal_info_line">
                        <p class="fs-20 fw-normal lh-140 text-white">Accounting email</p>
                        <div class="d-flex">
                            <input wire:model="user.accounting_email" value="{{$user->accounting_email}}" class="p_lg fw-normal lh-140 text-white bg-transparent border-0" id="ac_email">
                ...
                <div class="d-flex flex-column personal_info">
                    <div class="personal_info_line">
                        ...
                        <div class="d-flex">
                            <p wire:model="user.phone" class="p_lg fw-normal lh-140 text-white opacity-100">{{$user->phone}}</p>
                        </div>
                    </div>
                    <div class="personal_info_line">
                        <p class="fs-20 fw-normal lh-140 text-white">Billing address</p>
                        <div class="d-flex">
                            <input wire:model="user.billing_address" value="{{$user->billing_address}}" class="p_lg fw-normal lh-140 text-white bg-transparent border-0" id="address">
