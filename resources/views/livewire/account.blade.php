<form id="personal_data_form" wire:submit.prevent="submit" method="post">
    <div class="row personal_main">
        <div class="col-lg-2 col-12">
            <div class="personal_main_left">
                <img style="border-radius: 50%; width: 100px; height: 100px"
                     src="{{ Storage::url($user->avatar ?? 'images/blank-profile-picture-973460_150.png') }}">
                ...
                <div class="col-lg-4 col-12">
                    <div class="personal_info_line">
                        ...
                        <div class="d-flex">
                            ...
                            <label class="edit d-flex align-items-center" for="ac_email"><img
                                    src="/image/Edit.png"></label>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-12">
                ...
                <div class="col-lg-4 col-12">
                    <div class="personal_info_line">
                        ...
                        <div class="d-flex">
                            ...
                            <label class="edit d-flex align-items-center" for="company"><img
                                    src="/image/Edit.png"></label>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-12">
                    <div class="personal_info_line">
                        ...
                        <div class="d-flex">
                            ...
                            <label class="edit d-flex align-items-center" for="address"><img
                                    src="/image/Edit.png"></label>
                        </div>
                    </div>
                </div>
