            ...
            <div class="row">
                <div class="col-12">
                    <div class="section_img">
                        <p><img src="/image/section1___.png"></p>
                    </div>
                </div>
                <div class="col-12">
        ...
        <div class="section_main">
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="section_img">
                        <p><img src="/image/section2.png"></p>
                    </div>
                </div>
                <div class="col-lg-6 col-12">
    ...
    <div class="port_section">
        ...
        <div class="section_main">
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    <div class="section_img">
                        <p><img src="/image/section3.png"></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="section_main">
            <div class="row">
                <div class="col-lg-5 col-12">
                    <div class="section_img">
                        <p><img src="/image/section4.png"></p>
                    </div>
                </div>
    ...
    <div class="port_section">
        ...
        <div class="section_main">
            <div class="row">
                ...
                <div class="col-lg-5 col-12">
                    <div class="section_img">
                        <p><img src="/image/section5.png"></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="port_section">
        ...
        <div class="section_main">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section_img">
                        <p><img src="/image/section6.png"></p>
                    </div>
                </div>
            </div>
        </div>
